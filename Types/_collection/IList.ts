...
export default interface IList<T> {
     ...
     * @param [items] Коллекция с элементами для добавления
     * @example
     ...
     * @param item Элемент
     * @param [at] Позиция, в которую добавляется элемент (по умолчанию - в конец)
     * @example
     ...
     * @return Если true - элемент удален, если false - такого элемента нет в списке.
     * @example
     ...
     * @param from С какой позиции взять элемент
