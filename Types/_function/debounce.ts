...
/**
 * Откладывает выполнение функции на период задержки с случае повторного вызыва, игнорируя предыдущий вызов.
 * @remark
 ...
 *          происходит повторный вызов функции, то выполнение откладывается на период задержки, предыдущий вызов не выполняется.</li>
