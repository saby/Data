...
/**
 * Позвоялет игноририровать вызовы функции до тех пор, пока пока они не перестанут повторяться в течение периода задержки.
 * @remark
 * <h2>Параметры функции</h2>
 * <ul>
 *      <li><b>original</b> {Function} - функция, вызов которой нужно отложить.</li>
 ...
 * </ol>
 *
 * См. также функцию {@link Types/_function/throttle}, которая позволяет ограничивать частоту вызова функции.
 *
