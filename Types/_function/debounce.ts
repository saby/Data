...
/**
 * Функция выполняется после установленного периода задержки, выполняя только последний вызов из серии.
 * @remark
 ...
 * </ol>
 * 
 * В отличие от {@link Types/_function/throttle} повторный вызов функции в течении периода задержки не игнорируется.
 *
