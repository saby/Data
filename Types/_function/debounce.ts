...
/**
 * Функция игнорирует вызовы до тех пор, пока пока они не перестанут повторяться в течении периода задержки.
 * @remark
 ...
 * </ol>
 * 
 * Функция {@link Types/_function/throttle} имеет противоположный принцип работы.
 *
