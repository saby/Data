/**
 * Выполняется один раз в течение заданного периода задержки, игнорируя повторные вызовы.
 * @remark
 ...
 * </ul>
 * 
 * В отличие от {@link Types/_function/debounce} повторный вызов функции не приводит к переносу его выполнения на период задержки и игнорированию предыдущего вызова.
 *
 * <h2>Возвращает</h2>
