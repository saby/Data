 ...
 * <ul>
 *      <li><b>original</b> {Function} - функция, число вызовов которой нужно ограничить.</li>
 *      <li><b>delay</b> {Number} - период задержки в мс.</li>
 *      <li><b>[last=false]</b> {Boolean} - выполнить последний вызов по окончании задержки.
 *      </li>
 * </ul>
 *
 * <h2>Возвращает</h2>
 ...
 * </ol>
 *
 * См. также функцию {@link Types/_function/debounce debounce} которая позволяет игноририровать вызовы функции до тех пор, пока пока они не перестанут повторяться в течение указанного периода.
 *
