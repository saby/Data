/**
 * ВФункция выполняется один раз в течении периода задержки, игнорируя повторные вызовы.
 * @remark
 ...
 * 
 * Функция {@link Types/_function/debounce} имеет противоположный принцип работы.
 *
