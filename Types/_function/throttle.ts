 ...
 * </ol>
 *
 * См. также функцию {@link Types/_function/debounce} которая позволяет игноририровать вызовы функции до тех пор, пока пока они не перестанут повторяться в течение указанного периода.
 *
