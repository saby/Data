/**
 * Позволяет выполнять функцию не чаще, чем 1 раз в указанном интервале времени.
 * @remark
 ...
 *     <li>Если параметр last=true, и за время задержки один или несколько раз была вызвана функция, то будет выполнен только послединий вызов.
