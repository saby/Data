...
import MaterializedPath, {IOptions} from 'Types/_display/itemsStrategy/MaterializedPath';
import TreeDisplay from 'Types/_display/Tree';
import TreeItem from 'Types/_display/TreeItem';

describe('Types/_display/itemsStrategy/MaterializedPath', () => {
    interface IItem {
        id: number;
        children?: IItem[];
    }
