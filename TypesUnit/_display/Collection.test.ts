...
import Display from 'Types/_display/Abstract';
import CollectionDisplay from 'Types/_display/Collection';
import CollectionItem from 'Types/_display/CollectionItem';
import GroupItem from 'Types/_display/GroupItem';
...
import ComputeFunctor from 'Types/_entity/functor/Compute';
...
describe('Types/_display/Collection', () => {
    interface IItem {
        id: number;
        name?: string;
    }
    ...
    describe('.setGroup()', () => {
        ...
        it('should restore groups after the list will be assigned new items', () => {
            const list = new ObservableList({
                items: [
                    {id: 1, group: 2},
                    {id: 2, group: 3},
